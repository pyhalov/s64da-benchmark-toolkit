...
ALTER TABLE customer_address SET (parallel_workers = 32);
ALTER TABLE customer_demographics SET (parallel_workers = 32);
ALTER TABLE date_dim SET (parallel_workers = 32);
ALTER TABLE warehouse SET (parallel_workers = 32);
ALTER TABLE ship_mode SET (parallel_workers = 32);
ALTER TABLE time_dim SET (parallel_workers = 32);
ALTER TABLE reason SET (parallel_workers = 32);
ALTER TABLE income_band SET (parallel_workers = 32);
ALTER TABLE item SET (parallel_workers = 32);
ALTER TABLE store SET (parallel_workers = 32);
ALTER TABLE call_center SET (parallel_workers = 32);
ALTER TABLE customer SET (parallel_workers = 32);
ALTER TABLE web_site SET (parallel_workers = 32);
ALTER TABLE household_demographics SET (parallel_workers = 32);
ALTER TABLE web_page SET (parallel_workers = 32);
ALTER TABLE promotion SET (parallel_workers = 32);
ALTER TABLE catalog_page SET (parallel_workers = 32);
ALTER TABLE inventory SET (parallel_workers = 32);

ALTER TABLE catalog_returns SET (parallel_workers = 32);
ALTER TABLE web_returns SET (parallel_workers = 32);
ALTER TABLE store_returns SET (parallel_workers = 32);
ALTER TABLE web_sales SET (parallel_workers = 32);
